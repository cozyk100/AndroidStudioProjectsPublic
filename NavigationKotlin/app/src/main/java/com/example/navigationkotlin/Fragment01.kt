...
import com.example.navigationkotlin.databinding.Fragment01Binding
...
class Fragment01 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button02.setOnClickListener {
            ...
            // Fragment02へ
//            findNavController().navigate(R.id.action_fragment01_to_fragment02) // 引数を省略する場合
        ...
        binding.buttonMain.setOnClickListener {
            ...
            action.param2 = binding.message2.text.toString()
            // FragmentMainへ
//            findNavController().navigate(R.id.action_fragment01_to_fragmentMain) // 引数を省略する場合
            findNavController().navigate(action)
        }
    }
