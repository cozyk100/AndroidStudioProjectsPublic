...
import com.example.fragmentflowkotlin.databinding.FragmentMainBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button01.setOnClickListener{
            parentFragmentManager.commit {
                ...
                replace(R.id.fragmentView, Fragment01.newInstance("FragmentMainからのメッセージ"))
            }
        }
        binding.button02.setOnClickListener{
            parentFragmentManager.commit {
                addToBackStack(null)
                setReorderingAllowed(true) // ないとFragmentの遷移、back stack やアニメーションに問題が生じる
                replace(R.id.fragmentView, Fragment02.newInstance("FragmentMainからのメッセージ"))
            }
        }
    }
